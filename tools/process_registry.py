...
class ProcessRegistry:
    ...
    def _move_to_finished(self, session: ProcessSession):
        ...
        if was_running and session.notify_on_complete:
            ...
            # Redact BEFORE persisting or enqueueing so secrets never reach
            # the durable store or an [IMPORTANT: ...] message to the LLM.
            _redact_process_result(completion_evt)
