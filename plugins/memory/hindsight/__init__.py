...
Config via environment variables:
  ...
  HINDSIGHT_IDLE_TIMEOUT           -- embedded daemon idle timeout seconds; 0 disables shutdown (default: 0)
...
_DEFAULT_IDLE_TIMEOUT = 0  # 0 disables idle auto-shutdown -- Core is always-on
